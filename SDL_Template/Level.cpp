...
Level::Level(int stage, PlaySideBar * sideBar, Player * player) {
	...
	mStageLabel = new TextureGL("STAGE", "emulogic.ttf", 32, { 75, 75, 200 });
	...
	mReadyLabel = new TextureGL("READY", "emulogic.ttf", 32, { 150, 0, 0 });
	...
	mGameOverLabel = new TextureGL("GAME OVER", "emulogic.ttf", 32, { 150, 0, 0 });
