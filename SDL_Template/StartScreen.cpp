...
StartScreen::StartScreen() {
	...
	mPlayerOne = new TextureGL("1UP", "emulogic.ttf", 32, { 200, 0, 0 });
	mPlayerTwo = new TextureGL("2UP", "emulogic.ttf", 32, { 200, 0, 0 });
	mHiScore = new TextureGL("HI SCORE", "emulogic.ttf", 32, { 200, 0, 0 });
	...
	// logo entities
   	mLogo = new TextureGL("GalagaLogo.png", 0, 0, 360, 180);
	...
	mOnePlayerMode = new TextureGL("1 Player ", "emulogic.ttf", 32, { 230, 230, 230 });
	mTwoPlayerMode = new TextureGL("2 Players", "emulogic.ttf", 32, { 230, 230, 230 });
	mCursor = new TextureGL("Cursor.png");
	...
	mNamco = new TextureGL("namcot", "namco__.ttf", 36, { 200, 0, 0 });
	mDates = new TextureGL("1981 1985 NAMCO LTD.", "emulogic.ttf", 32, { 230, 230, 230 });
	mRights = new TextureGL("ALL RIGHTS RESERVED", "emulogic.ttf", 32, { 230, 230, 230 });
